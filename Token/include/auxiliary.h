...
{
	CK_VERSION	version;            // must set vesion.major = 1  version.minor = 0
	char*		strTokenName;
	char*		strOldSOPin;
	char*		strSOPin;
	char*		strUserPin;
...
typedef struct _AUX_INIT_TOKEN_LOWLEVL_PKI_V11
{
	CK_VERSION	version;			// must set vesion.major = 1  version.minor = 1
	char*		strTokenName;
	char*		strOldSOPin;
	char*		strSOPin;
	char*		strUserPin;
...
} AUX_INIT_TOKEN_LOWLEVL_PKI_V11, CK_PTR AUX_INIT_TOKEN_LOWLEVL_PKI_V11_PTR;
